            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-lg font-bold text-slate-900">Dashboard Admin</h1>
                            <p class="text-sm text-slate-500">Kelola sistem antrian AntriYuk</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('home') }}" class="text-slate-600 hover:text-slate-900 px-3 py-2 text-sm font-medium">
                            Lihat Situs
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div class="bg-white rounded-2xl p-6 border border-slate-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-900 mt-1">{{ $stats['total_locations'] }}</p>
                            <p class="text-sm text-green-600 mt-1">{{ $stats['active_locations'] }} aktif</p>
                        </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Total Operator</p>
                            <p class="text-3xl font-bold text-slate-900 mt-1">{{ $stats['total_operators'] }}</p>
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Tiket Hari Ini</p>
                            <p class="text-3xl font-bold text-slate-900 mt-1">{{ $stats['today_tickets'] }}</p>
                            <p class="text-sm text-green-600 mt-1">{{ $stats['today_completed'] }} selesai</p>
                        </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-slate-400 mt-1">menit/layanan</p>
                        </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                <a href="{{ route('admin.locations') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg hover:border-blue-200 transition-all">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Kelola Lokasi</h3>
                    <p class="text-slate-600 text-sm">Tambah, edit, atau hapus lokasi layanan dan loket</p>
                ...
                <a href="{{ route('admin.users') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg hover:border-green-200 transition-all">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Kelola Pengguna</h3>
                    <p class="text-slate-600 text-sm">Atur role pengguna dan assign operator ke lokasi</p>
                ...
                <a href="{{ route('locations.index') }}" class="group bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg hover:border-purple-200 transition-all">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Lihat Halaman Publik</h3>
                    <p class="text-slate-600 text-sm">Preview tampilan untuk pengunjung dan customer</p>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-bold text-slate-900">Ringkasan Lokasi</h2>
                        <p class="text-slate-500 text-sm mt-1">Status semua lokasi layanan hari ini</p>
                    </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th class="text-center px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Tiket Hari Ini</th>
                                <th class="text-center px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Menunggu</th>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center mr-4">
                                                <span class="text-blue-600 font-bold text-sm">{{ substr($location->code, 0, 2) }}</span>
                                            </div>
                                            <span class="font-semibold text-slate-900">{{ $location->name }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="bg-slate-100 text-slate-700 px-3 py-1.5 rounded-lg text-sm font-medium">{{ $location->code }}</span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="text-slate-900 font-semibold">{{ $location->today_tickets_count }}</span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end space-x-3">
                                            ...
                                            <a href="{{ route('admin.locations.edit', $location) }}" class="text-slate-600 hover:text-slate-700 font-medium text-sm">
                                                Edit
                                            </a>
                                        </div>
                                    </td>
